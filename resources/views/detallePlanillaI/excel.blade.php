<table>
  <thead>
    ...
    <tr>
      <th>Planilla de Indemnización del Personal Correspondiente al año {{ $data->anio }}</th>
    </tr>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td>Salario</td>
      <td>Indemnización Según Ley</td>
      <td>Tope de Indemnización</td>
      <td>Base de Retención de Indemnización</td>
      {{-- <td>ISR</td> --}}
      <td>PGR</td>
